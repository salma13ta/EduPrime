...
export default function HeroSection() {
    return (
        <section className="relative flex min-h-screen items-center justify-center px-6 py-20 text-white">
            <div className="absolute top-0 left-1/2 h-100 w-200 -translate-x-1/2 rounded-full bg-purple-600/15 blur-[140px] pointer-events-none" />
            <div className="absolute top-[40%] right-0 h-125 w-125 rounded-full bg-blue-600/10 blur-[160px] pointer-events-none" />
            ...
            <div className="relative mx-auto w-full max-w-7xl text-center">
                <motion.div
                    ...
                    className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3.5 py-1.5 text-xs text-gray-300 backdrop-blur-md transition-all hover:border-purple-500/50 sm:text-sm"
                >
                ...
                <motion.h1
                    ...
                    className="text-gray-600 mx-auto max-w-4xl text-4xl font-black leading-[1.1] tracking-tight text-white sm:text-6xl md:text-7xl"
                >
                    Learn From The <br />
                ...
                <motion.div
                    ...
                    className="mx-auto mt-10 flex max-w-2xl items-center gap-2 rounded-2xl border border-white/10 bg-[#131625]/90 p-2 shadow-2xl transition-all focus-within:border-purple-500/60"
                >
                    ...
                    />
                    <button className="shrink-0 rounded-xl bg-purple-600 px-6 py-3 text-sm font-medium text-white transition-all hover:bg-purple-500">
                        Search
                    </button>
                </motion.div>
                ...
                >
                    <Link
                        href={ROUTES.COURSES}
                        className="flex items-center gap-2 rounded-xl bg-purple-600 px-8 py-3.5 text-sm font-semibold text-white shadow-xl shadow-purple-600/30 transition-all hover:bg-purple-500 active:scale-95"
                    >
                        <BookOpen className="h-4 w-4" /> Start Learning
                    </Link>
                    <Link
                        href={ROUTES.WATCH_VIDEO("intro")}
                        className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-8 py-3.5 text-sm font-semibold text-white transition-all hover:bg-white/10"
                    >
                        Watch Demo
                    </Link>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="relative mx-auto mt-16 max-w-4xl overflow-hidden rounded-3xl border border-white/10 bg-[#131625]/60 p-2 shadow-2xl backdrop-blur-sm sm:p-4"
                >
